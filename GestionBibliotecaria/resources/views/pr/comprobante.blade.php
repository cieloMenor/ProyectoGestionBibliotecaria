...
<body>
    <div style="text-align: center;" class="ticket">
        <p>TIENDA DE LIBROS S.A.C.</p>
        <p>R.U.C. 20601790310</p>
        <p>AV. GONZALO UGAS SALCEDO NRO. 401</p>
        ...
        <p>CODIGO: {{$comprobante->idcomprobante}}</p>
        <br>
        <p>usuario Cliente: {{$comprobante->clientes->Usuario}}</p>
        <p>{{$comprobante->clientes->Apellidosusuario}}, {{$comprobante->clientes->Nombresusuario}}</p>
        <p>{{$comprobante->clientes->Correousuario}}</p>
        ...
        <div class="product">
            ...
            <table>
                <tbody>
                        <tr>
                            <td style="width: 60%; text-align: left;">
                                {{$comprobante->libros->Titulo}}</td>
                                <td style="width: 60%; text-align: left;">
                                    1</td>
                            <td style="width: 40%; text-align: right;">
                                S/<?php
                                $num = $comprobante->monto;
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td style="width: 40%; text-align: right;">S/ 0.00</td>
                    </tr>
                    <tr>
                        <td style="width: 60%; text-align: left;">Op. No Gravadas</td>
                        <td style="width: 40%; text-align: right;">S/ 0.00</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 60%; text-align: left;">ICBPER</td>
                        <td style="width: 40%; text-align: right;">S/ 0.00</td>
                    </tr>
                    <tr>
        ...
        <p style="text-align: left;">Medio de Pago: Online</p>
        <br>
        
        <!--<p style="font-size: 13px;">UNA VEZ ENTREGADA LA MERCADERÍA NO HAY RECLAMOS NI DEVOLUCIONES.</p>-->
        <!--<p style="font-size: 13px;">DESPUÉS DE 7 DÍAS DE ALMACENAMIENTO, SE COBRARÁ S/.7 POR DÍA.</p>-->
        <br>
        <p>
</p>
