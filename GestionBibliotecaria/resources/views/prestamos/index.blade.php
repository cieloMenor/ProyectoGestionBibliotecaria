            ...
            @else
                @foreach($prestamos as $item) 
                    <tr> 
                        ...
                        <td> 
                            <a href="{{route('prestamo.ver',$item->PrestamoID)}}" class="btn btn-primary"> <i class="fa fa-eye" aria-hidden="true"></i></a>
                            ...
                            <a href="{{route('ticket',$item->PrestamoID)}}" target="_blank" class="btn btn-warning"> <i class="fas fa-file-pdf    "></i></a>
